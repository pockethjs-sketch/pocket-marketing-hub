...
| 승인함 | 08, 09, 10 | 10, 15 |
| 성과 추적 | 12 (`CLIENT_VIEWER` 채널 제한 시 05 추가) | 없음 |
...
- `04_프로젝트권한`: 계정과 고객사·프로젝트 연결, `READ_ONLY`, `allowed_pages_json`을 저장합니다. 허용 페이지 코드는 `overview`, `plan`, `tasks`, `content`, `tracking`, `performance`, `files`입니다.
