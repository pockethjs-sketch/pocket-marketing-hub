...
- 참조 HTML 3개
- 데모 고객사·프로젝트 없음. 현재 활성 운영 범위는 UND와 무극 프로젝트이다. 무극은 `260824무극_캠페인_일정표.xlsx`를 원천으로 프로젝트 기간 2026-08-10~09-09와 업무 20건을 `06_업무`에 저장한다. 원본의 완료·진행중·날짜확인 상태는 각각 `DONE`·`IN_PROGRESS`·`ON_HOLD`로 정규화하며, 채널 세팅·계정 구축·아트워크·블로그 세팅 4건은 `P0`, 콘텐츠 제작·포스팅·운영·인터렉션 16건은 `M1`로 분류한다.
