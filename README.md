...
UND 팀 트래커에서 승인한 업무 144건은 `APPROVED_PLAN` 원천으로 복구되어 운영 화면에 표시됩니다. 기존 103건의 상태·담당자·메모는 보존하고 누락 업무만 추가했습니다. 현재 운영 원장과 화면에는 UND 고객사·프로젝트만 활성 상태이며, 무극을 포함한 데모 고객사·프로젝트는 제거했습니다.
